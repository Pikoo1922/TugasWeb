...
// membuat object
$akun1 = new akunBank("12345", 100000);

$akun1->setNama("Ficko");

echo "Nama: " . $akun1->getNama() . "<br>";
echo "No Rekening: " . $akun1->getAccountNumber() . "<br>";
echo "Saldo: " . $akun1->tampilkanUang() . "<br>";
echo "Pajak: " . $akun1->hitungPajak();
